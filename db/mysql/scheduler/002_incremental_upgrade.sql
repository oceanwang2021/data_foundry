-- Scheduler DB incremental upgrade (consolidated from former scheduler-service migrations V002+)
-- Use only when upgrading an existing schema. For a fresh schema, use db/mysql/scheduler/001_schema.sql.
