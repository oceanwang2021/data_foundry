...
public class MybatisRequirementRepository implements RequirementRepository {
  ...
  private static Requirement toDomain(RequirementRecord record) {
    ...
    r.setCreatedBy(record.getCreatedBy());
    r.setCreatedByAccount(record.getCreatedByAccount());
    r.setOwner(record.getOwner());
    r.setOwnerAccount(record.getOwnerAccount());
    r.setAssignee(record.getAssignee());
    r.setAssigneeAccount(record.getAssigneeAccount());
    r.setAcceptanceOwner(record.getAcceptanceOwner());
    r.setAcceptanceOwnerAccount(record.getAcceptanceOwnerAccount());
  ...
  private static RequirementRecord toRecord(Requirement requirement) {
    ...
    record.setCreatedBy(requirement.getCreatedBy());
    record.setCreatedByAccount(requirement.getCreatedByAccount());
    record.setOwner(requirement.getOwner());
    record.setOwnerAccount(requirement.getOwnerAccount());
    record.setAssignee(requirement.getAssignee());
    record.setAssigneeAccount(requirement.getAssigneeAccount());
    record.setAcceptanceOwner(requirement.getAcceptanceOwner());
    record.setAcceptanceOwnerAccount(requirement.getAcceptanceOwnerAccount());
